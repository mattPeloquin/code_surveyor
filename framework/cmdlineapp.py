...
class SurveyorCmdLine( object ):
    ...
    SummaryToInclude = set([
            ...
            'file.content', 'file.dead', 'file.ignored', 'routine.complexity', 'search.total'])
    ...
    def __init__(self):
        ...
        # Objects we create and delegate to
        self._args = None
        self._job = None
        self._writer = None
        self._out = None
    ...
    def set_logging(self, level, **kwargs):
        '''
    ...
    def _filter_dupes(self, filePath, measures, analysisResults):
        ...
        if firstDupeFilePath:
            ...
            # Special case grabbing the NBNC size, to have easy measure of
    ...
    def _display_file_progress(self, filePath, measureTime):
        '''
        Provide some per-file screen feedback
        '''
        if self._progress:
            progressStr = None
    ...
    def _display_summary(self):
        ...
        self._print_clear('')
        # Any errors swallowed during the run
        if self._errorList:
        ...
        # In verbose mode break out each measure by file type, and sort by size
